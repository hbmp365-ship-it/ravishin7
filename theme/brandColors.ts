/** TeeShot 컨텐츠 생성기 브랜드 컬러 */
export const BRAND_PRIMARY = '#006B68';
export const BRAND_PRIMARY_HOVER = '#005552';
export const BRAND_PRIMARY_GRADIENT_VIA = '#007A77';

export const BRAND_ORANGE = '#F97000';
export const BRAND_ORANGE_HOVER = '#E06600';

/** 컨텐츠 생성 영역 — 주·보조 CTA 제외 무채색 버튼 계층 */
export const BTN_EMPHASIS =
