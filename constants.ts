...
- **🚨 중요: 디자인, 가이드라인, 색상, 레이아웃, 타이포그래피 등 디자인 관련 내용은 제거하고, 인포그래픽에 들어갈 내용(텍스트, 숫자, 통계, 정보)에만 집중하세요.**
- **🚨 중요: 위 섹션에서 작성한 실제 텍스트 내용(제목, 문구, 숫자)을 모두 포함하여 하나의 완성된 프롬프트로 작성하세요.**

[하나의 통합된 프롬프트 작성 형식]
인포그래픽, [위 섹션 1의 제목 텍스트와 주요 내용 텍스트를 포함], [위 섹션 2의 제목 텍스트와 주요 내용 텍스트를 포함], [위 섹션 3의 제목 텍스트와 주요 내용 텍스트를 포함], 한글 텍스트는 정확히 표시되도록 "Text in the image should be exactly '[실제 한글 텍스트]'" 형식으로 명시, TEESHOT/TeeShot/티샷 브랜드명/로고/텍스트 절대 금지

- **한글로 작성** (영어 사용 금지)
- **🚨 중요: 디자인 관련 내용(색상, 레이아웃, 타이포그래피, 인스타그램 최적화, 모바일 최적화 등)은 포함하지 마세요.**
- **🚨 중요: 인포그래픽에 들어갈 내용(텍스트, 숫자, 통계, 정보)에만 집중하세요.**
- **🚨 중요: 위 섹션에서 작성한 실제 텍스트 내용(제목, 문구, 숫자)을 모두 인포그래픽에 포함하세요.**
