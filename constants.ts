...
2. 절대 금지: 이미지 프롬프트에 TEESHOT, TeeShot, 티샷 등의 로고, 브랜드명, 텍스트를 절대 포함하지 마세요. 이미지에는 어떤 텍스트나 로고도 포함하지 않도록 하세요.**
...
📸 이미지 프롬프트: [표지 이미지 설명, 영어로, 사람이 포함된 경우 동양인(Asian/East Asian)을 기본으로 명시, TEESHOT/TeeShot/티샷 로고나 텍스트 절대 금지]
...
📸 이미지 프롬프트: [영어 설명, 사람이 포함된 경우 동양인(Asian/East Asian)을 기본으로 명시, TEESHOT/TeeShot/티샷 로고나 텍스트 절대 금지]
...
- **절대 금지: TEESHOT, TeeShot, 티샷 등의 로고, 브랜드명, 텍스트를 이미지에 포함하지 마세요. 이미지에는 어떤 텍스트나 로고도 포함하지 않도록 하세요.**
- 비율 정보 포함
