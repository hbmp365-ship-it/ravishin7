...
export const YouTubeShortsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12.19 12.82a1 1 0 0 0 1.62 0l4.33-6.49a1 1 0 0 0-.81-1.59H6.67a1 1 0 0 0-.81 1.59z" />
      <path d="M11.81 11.18a1 1 0 0 0-1.62 0l-4.33 6.49a1 1 0 0 0 .81 1.59h10.66a1 1 0 0 0 .81-1.59z" />
    </svg>
);
